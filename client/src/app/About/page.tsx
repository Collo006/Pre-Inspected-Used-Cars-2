        ...
        <div >
            ...
            <div className={`bg-lightSky ml-0 w-screen rounded-xl mt-10 `}>
               <div className={`relative mx-auto w-full min-w-[400px] h-[700px]`}>
                ...
                <div className={`ml-1 mr-1 w-screen h-[600px] rounded-xl mt-10 grid grid-cols-[1fr_2fr] gap-1`}>
                    ...
                    <Image src="/images/people.jpg" alt="Background" className={`rounded-xl object-cover `} fill />
                      ...
                      <div className={`bg-white rounded-xl`}>
                       <h1 className={`${exoFont.className} text-3xl text-darkSky font-bold text-center pt-5`}>WHY CHOOSE PINUC</h1>
