...
import { FaCar, FaFile, FaKey, FaMoneyBills, FaPhone, FaUser, FaUsers } from "react-icons/fa6";
    ...
    return (
        <div>
            ...
            <div className={`bg-white ml-10 w-[1600px] rounded-xl  `}>
                ...
                <div className={` mt-5 pb-10 grid grid-cols-[repeat(3,300px)] gap-2 justify-center`}> {/** remember this shortcut */}
        ...
        <div className={`bg-white ml-10 w-[1600px] rounded-xl mt-10 `}>
